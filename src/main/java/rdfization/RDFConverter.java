...
public class RDFConverter implements DataConverter {
	...
	public static void convertFromGraph(String fullGraph, OutputStream out) throws Exception{
		...
		QuerySolution rs = (QuerySolution)results.next();	
		...
		Resource ratt = diachronModel.createResource(rattID, DiachronOntology.recordAttribute)
					.addProperty(DiachronOntology.predicate, p.as(Resource.class));
		if(o.isResource()) 
		ratt.addProperty(DiachronOntology.object, o.as(Resource.class));
		else if (o.isLiteral()) 
		ratt.addProperty(DiachronOntology.object, o.as(Literal.class));
