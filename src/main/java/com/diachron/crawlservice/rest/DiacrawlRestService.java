package com.diachron.crawlservice.rest;

import com.diachron.crawlservice.scheduler.CrawlStatusJobListener;
import com.diachron.crawlservice.scheduler.CrawlStatusJob;
...
public class DiacrawlRestService {
    ...
    public Response getcrawlid(String pageToCrawl) {
        ...
        try {
            ...
            //ConfigControllerOld configController = ConfigControllerOld.getInstance();
