...
public class UnqueueComplexChange
{
    ...
    {      
        ...
        try {
            responseMessage.put("Status", "Queue Empty");
        } catch (JSONException ex) {
            Logger.getLogger(UnqueueComplexChange.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        return Response.status(Response.Status.OK).entity(responseMessage.toString()).build();
    }
